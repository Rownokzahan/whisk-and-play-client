    ...
    return (
        <div className="my-28">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                <div className="border shadow rounded-md p-8 space-y-4" data-aos="slide-right" data-aos-duration="1000">
                ...
                <div className="border shadow rounded-md p-8 space-y-4 relative" data-aos="slide-left" data-aos-duration="1000">
                ...
                <div className="border shadow rounded-md p-8 space-y-4" data-aos="slide-left" data-aos-duration="1000">
